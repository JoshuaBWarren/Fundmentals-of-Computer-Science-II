...
public class IntSearchTreeClient {
	public static void main(String[] args) {
		...
		/*
		 * System.out.print("Next int (0 to quit)? "); int number = console.nextInt();
		 * while (number != 0) { numbers.add(number);
		 * System.out.print("Next int (0 to quit)? "); number = console.nextInt(); }
		 * System.out.println();
		 */
