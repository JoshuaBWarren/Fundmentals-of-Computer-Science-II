...
public class HashIntSet {
	...
	// Returns a string representation of this queue, such as "[10, 20, 30]";
			 ...
			 * Exercise 1:
			 * 
			 * Write a method in the HashIntSet class called addAll that accepts another hash
			 * set as a parameter and adds all of the elements from the other set into the 
			 * current set.
			 */
			public void addAll(HashIntSet input) {
				
				// go through the input and assign a value to a variable
				for(int i = 0; i < input.elementData.length; i++) {
					HashEntry value = input.elementData[i];
					
					// since we have to check if there's a value or not, use while loop
					while(value != null) {
						// if this doesn't contain a value (collusion)
			 ...
			 * element from the other set.
			 */
			public boolean containsAll(HashIntSet input) {
				
				// same as above: go through the input and assign values
			    for(int i = 0; i < input.elementData.length; i++) {
			        HashEntry value = input.elementData[i];

			        // while the value isn't null
			        while(value != null) {
			    ...
			    // if we get here then it's gotta be true
			    return true;
			}
			 ...
			 * Exercise 3:
			 * 
			 * Write a method in the HashIntSet class called removeAll that accepts another 
			 * hash set as a parameter and ensures that this set does not contain any of the 
			 * elements from the other set.
			 */
			public void removeAll(HashIntSet input) {
				
				// go through the input and assign values
			    for(int i = 0; i < input.elementData.length; i++) {
			        HashEntry current = input.elementData[i];
